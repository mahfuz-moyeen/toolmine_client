...
const MyPortfolio = () => {
    ...
    return (
        <div className='bg-black pb-10'>
            <div className="hero min-h-screen bg-neutral" style={{ background: `url(${portfolioBg})`, backgroundSize: 'cover' }}>
            ...
            <div>
                <div className="card rounded-none lg:card-side bg-black shadow-xl">
                    ...
                    <div className="card-body p-10">
                        <h2 className="card-title text-gray-300 text-3xl py-5">My Info</h2>
                        <hr />
