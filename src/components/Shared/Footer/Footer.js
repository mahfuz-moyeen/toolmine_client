        ...
        <div>
            <footer className="footer p-10 bg-accent text-base-100">
                ...
                <div >
                    ...
                    <p className="link link-hover">Safety Solutions</p>
                    <p className="link link-hover">Tools Support</p>
                    <p className="link link-hover">Home Delivery</p>
            ...
            <footer className="footer footer-center p-4 bg-accent text-base-200">
                <footer className="footer lg:justify-between items-center p-4 text-base-100">
                    <div className="items-center grid-flow-col">
                        <p className='text-base-200'>Copyright © 2022 - All right reserved by Toolmine Manufacturer Ltd</p>
                    </div>
                    <div className="grid-flow-col gap-4 md:place-self-center md:justify-self-end">
                        ...
                        <a href='https://www.youtube.com/watch?v=GbdeOIKS7jE'>
                            <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" className="fill-current"><path d="M19.615 3.184c-3.604-.246-11.631-.245-15.23 0-3.897.266-4.356 2.62-4.385 8.816.029 6.185.484 8.549 4.385 8.816 3.6.245 11.626.246 15.23 0 3.897-.266 4.356-2.62 4.385-8.816-.029-6.185-.484-8.549-4.385-8.816zm-10.615 12.816v-8l8 3.993-8 4.007z"></path></svg>
                        </a>
                        <a href='https://www.facebook.com/mahfuz.moyeen.111'>
